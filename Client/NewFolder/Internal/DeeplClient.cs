...
namespace DeepL.Internal
{
    ...
    internal class DeepLClient : IDisposable
    {
        ...
        public static object JsonUtils { get; private set; }
        public static object Policy { get; private set; }
              ...
              bool downloadingDocument = false)
        {
            ...
            try
            {
                var errorResult = await JsonUtils.DeserializeAsync<ErrorResult>(responseMessage)
    ...
    internal class TimeoutRejectedException
    {
    }

    internal class PolicyHttpMessageHandler : HttpMessageHandler
    {
        private object policy;

        public PolicyHttpMessageHandler(object policy)
        {
            this.policy = policy;
        }
    ...
    internal class HttpClientAndDisposeFlag
    {
    ...
    [Serializable]
    internal class QuotaExceededException : Exception
    {
    ...
    [Serializable]
    internal class GlossaryNotFoundException : Exception
    {
        public GlossaryNotFoundException()
        {
        }
        ...
        public GlossaryNotFoundException(string? message, Exception? innerException) : base(message, innerException)
        {
        }

        protected GlossaryNotFoundException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
    ...
    [Serializable]
    internal class DocumentNotReadyException : Exception
    {
        ...
        public DocumentNotReadyException(string? message, Exception? innerException) : base(message, innerException)
        {
        }

        protected DocumentNotReadyException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }

    [Serializable]
    internal class DeepLException : Exception
    {
    ...
    internal class LargeFormUrlEncodedContent : HttpContent
    {
        private IEnumerable<KeyValuePair<string, string>> enumerable;

        public LargeFormUrlEncodedContent(IEnumerable<KeyValuePair<string, string>> enumerable)
        {
